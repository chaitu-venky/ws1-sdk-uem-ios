...
### New Features
- Upgraded OpenSSL main to 3.5.7 LTS and FIPS to 3.1.2 LTS for security compliance.
- Configurable option for admins to add watermarks seamlessly to designated views with WS1 SDK API.
- Dropped Support for iOS 16 
- Support ability to retrieve seeded email address from the UEM endpoint for identity resolution
...
## Workspace ONE SDK 26.03.0 for iOS - Apr 2026

### New Features
- Updated minimum supported Xcode version to 26.1.1
...
## Workspace ONE SDK 26.02.0 for iOS - Feb 2026

### New Features
- Updated OpenSSL to version 3.4.4 to strengthen security, improve performance, and ensure compliance with modern cryptographic standards.
...
## Workspace ONE SDK 26.01.0 for iOS - Jan 2026
...
## Workspace ONE SDK 25.11.0 for iOS - Nov 2025

### New Features
- Data loss prevention (DLP) based control for Writing Tools.
- Multipart log upload support for third-party applications.
- Bug fixes and improvements.. 
...
## Workspace ONE SDK 25.08.0 for iOS - Aug 2025

### New Features
- Show a message in screenshot obfuscation while capturing screenshots.
- Bug fixes and improvements.. 
